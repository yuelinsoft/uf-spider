...
def get_html(url, *para):
    headers_info = {
        ...
        'Referer': 'http://xyjg.egs.gov.cn/ECPS_HB/searchList.jspx',
...
def mul_page(pageSoup, page_tag, url_page_part, key_list, dlink, idname, glb_id):
    ...
    dict_ba_list = []
    id = glb_id
    url_home = "http://xyjg.egs.gov.cn/ECPS_HB/"
    id = id.split("=")[-1]
    pagelt = 2
...
class Pool():
    ...
    def basicinfo_execute(self, pageSoup):
        ...
        if dict_ba != {}:
            dict_ba = common.basicinfo_dict(dict_ba,u'湖北')
        dict_ba_list = []
...
if __name__ == '__main__':
    # 缺例子的：股权更变, 严重违法信息。
    # id = '/businessPublicity.jspx?id=EDA82A1684364C8ED50229B99A0DB5FA'  # （变更，行政处罚）http://xyjg.egs.gov.cn/ECPS_HB/businessPublicity.jspx?id=EDA82A1684364C8ED50229B99A0DB5FA
    # id = '/businessPublicity.jspx?id=0582F8DBDE2019A28A1AF8A926A4E293'  # （主要人员，抽查检查）http://xyjg.egs.gov.cn/ECPS_HB/businessPublicity.jspx?id=0582F8DBDE2019A28A1AF8A926A4E293
    # id = '/businessPublicity.jspx?id=426876577F69E9651C884CC075B47EC4'  # （股东【翻页】，经营异常，司法协助页面）http://xyjg.egs.gov.cn/ECPS_HB/businessPublicity.jspx?id=426876577F69E9651C884CC075B47EC4
    # id = '/businessPublicity.jspx?id=FD14C88E8482547870F5B3FC8D4604D1'  # （股权出质,动产抵押，股权冻结）http://xyjg.egs.gov.cn/ECPS_HB/businessPublicity.jspx?id=FD14C88E8482547870F5B3FC8D4604D1
    id_number = '/businessPublicity.jspx?id=35EE3A04E8A88D086F9B06E632EEDF5C'  # （分支机构）http://xyjg.egs.gov.cn/ECPS_HB/businessPublicity.jspx?id=35EE3A04E8A88D086F9B06E632EEDF5C
    main(id_number)
