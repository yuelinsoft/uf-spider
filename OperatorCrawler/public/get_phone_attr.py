...
def get_phone_attr(phone_num):
    ...
    if response:
        try:
            ...
            return return_result(code=2000, data=data, desc=u'查询成功')
        except (KeyError, IndexError):
            return return_result(code=4500, data={})
        except (ValueError, Exception):
            return return_result(code=4100, data={})
    else:
        return return_result(code=4000, data={})
# end
